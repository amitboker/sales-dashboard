          ...
          <motion.button
            ...
            className={`flex items-center gap-2 rounded-xl px-4 py-2 text-[13px] font-medium transition-all duration-200 cursor-pointer border ${
              isActive
                ...
                : "bg-[var(--color-surface,#fff)] border-[var(--color-border,#e5e5e5)] text-[var(--color-muted,#828282)] shadow-[0_1px_4px_rgba(0,0,0,0.06)] hover:border-[var(--color-primary,#DAFD68)]/50 hover:text-[var(--color-text,#000)] hover:shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            }`}
          >
            <mode.icon
